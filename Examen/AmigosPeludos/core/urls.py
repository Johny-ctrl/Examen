...
from .views import home, Productos, AgregarCat, AgregarPro,Registro,del_producto,ModificarPro,Admin,Carro,agrega_carro,del_carro,res_carro,limpiar_carro,Suscribete
